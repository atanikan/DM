...
# Read data
setwd("C:/Users/Aditya/Desktop/Data Mining/hw1/data")
test.master <- lapply(list.files(pattern="u.*[.]test",full.names=T, ignore.case = T, recursive = T), read.table);
...
for (idx in 1:1) #5 fold cross-validation
{
